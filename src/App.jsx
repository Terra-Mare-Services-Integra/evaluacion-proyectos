...
.login-bg-lines {
  ...
  background-image:
    linear-gradient(rgba(107,63,160,0.06) 1px, transparent 1px),
    linear-gradient(90deg, rgba(107,63,160,0.06) 1px, transparent 1px);
  background-size: 60px 60px;
}
.login-split { position: relative; z-index: 2; display: flex; width: 100%; }
.login-left {
  flex: 1; display: flex; flex-direction: column; justify-content: center;
  padding: 80px 60px; border-right: 1px solid rgba(107,63,160,0.2);
}
.login-left-eyebrow {
...
.login-left-title span { color: var(--purple2); display: block; }
.login-left-line { width: 48px; height: 3px; background: var(--purple); margin: 20px 0; }
.login-left-sub {
...
.login-card {
  ...
  border: 1px solid rgba(107,63,160,0.25); border-radius: 16px;
...
.login-fg input:focus { border-color: var(--purple2); background: rgba(255,255,255,0.09); }
.login-btn {
...
.login-btn:hover { background: var(--purple2); }
...
.login-back:hover { color: var(--purple2); }
...
.header-divider { width: 1px; height: 24px; background: rgba(107,63,160,0.3); margin: 0 2px; }
.header-main { font-size: 13px; font-weight: 800; color: #fff; letter-spacing: 2px; text-transform: uppercase; }
.header-sub { font-size: 9px; color: var(--purple2); letter-spacing: 1px; font-family: var(--mono); margin-top: 1px; text-transform: uppercase; }
...
.hero-eyebrow { font-family: var(--mono); font-size: 10px; letter-spacing: 3px; color: var(--purple2); text-transform: uppercase; margin-bottom: 14px; }
...
.hero-line { width: 48px; height: 3px; background: var(--purple); margin: 18px 0; }
...
.card-accent-bar { height: 3px; background: var(--card-color, var(--purple)); flex-shrink: 0; opacity: 0; transition: opacity .2s; }
.modulo-card.activo { cursor: pointer; }
.modulo-card.activo:hover { border-color: var(--card-color, var(--purple)); box-shadow: 0 6px 24px rgba(11,22,41,0.12); transform: translateY(-3px); }
...
.card-tag { font-family: var(--mono); font-size: 9px; padding: 2px 7px; background: #F3F0F8; border: 1px solid var(--border); border-radius: 4px; color: var(--muted); }
.card-footer { padding: 12px 20px; border-top: 1px solid var(--border); display: flex; align-items: center; justify-content: space-between; background: #FAF8FF; }
...
/* ── FOOTER ── */
.portal-footer { border-top: 1px solid rgba(107,63,160,0.2); padding: 20px 40px; display: flex; align-items: center; justify-content: space-between; background: var(--navy); }
.footer-left  { font-family: var(--mono); font-size: 10px; color: rgba(255,255,255,0.25); }
.footer-right { font-family: var(--mono); font-size: 10px; color: var(--purple2); opacity: 0.5; }
    ...
    <div className="login-page">
      ...
      <div className="login-split">
        <div className="login-left">
          <div className="login-left-eyebrow">Herramientas de análisis</div>
          <div className="login-left-title">
            EVALUACIÓN<span>DE PROYECTOS</span>
          </div>
          <div className="login-left-line" />
          <div className="login-left-sub">
            Modelos financieros y análisis operativo para decisiones de inversión marítima.
          </div>
          <div className="login-left-tag">Grupo PL · Acceso restringido</div>
        </div>
        <div className="login-right">
          <div className="login-card">
            ...
            <div className="login-footer">Evaluación de Proyectos · Grupo PL</div>
...
function ModuloCard({ mod }) {
  ...
  const handleClick = () => { if (isActivo && mod.url) window.location.href = mod.url; };
    ...
    <>
      ...
      <header className="header">
        <div className="header-brand">
          <div>
            ...
            <div className="header-sub">Grupo PL · Herramientas de análisis</div>
          </div>
        </div>
      ...
      <div className="hero">
        <div className="hero-content">
          <div className="hero-eyebrow">Grupo PL · Herramientas de análisis</div>
          <h1 className="hero-title">Evaluación de <span>Proyectos</span></h1>
          <div className="hero-line" />
          <div className="hero-tagline">Modelos financieros y análisis operativo para decisiones de inversión marítima.</div>
      ...
      <footer className="portal-footer">
        <div className="footer-left">Evaluación de Proyectos · Grupo PL · Confidencial</div>
